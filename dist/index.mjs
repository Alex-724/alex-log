...
class Logger {
    ...
    _rotateLogIfNeeded(filePath) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const stats = yield promises.stat(filePath);
                if (stats.size >= this.maxFileSize) {
                    const newPath = `${filePath}.${Date.now()}`;
                    yield promises.rename(filePath, newPath);
                }
            }
            catch (err) {
                if (err.code !== 'ENOENT') {
    ...
    _appendLog(filePath, text) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield promises.appendFile(filePath, `${text}\n`);
            }
            catch (err) {
    ...
    _readLog(filePath, date) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const data = yield promises.readFile(filePath, 'utf8');
                if (date) {
